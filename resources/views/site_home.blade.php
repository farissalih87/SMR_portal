...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="{{ asset('site_assets/img/apple-touch-icon-72x72-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="{{ asset('site_assets/img/apple-touch-icon-114x114-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="{{ asset('site_assets/img/apple-touch-icon-144x144-precomposed.png') }}">
	...
	<link href="{{ asset('site_assets/css/vendors.css') }}" rel="stylesheet">
...
<body>
	...
	<!-- COMMON SCRIPTS -->
    <script src="{{ asset('site_assets/js/jquery-2.2.4.min.js') }}"></script>
    <script src="{{ asset('site_assets/js/common_scripts.js') }}"></script>
    <script src="{{ asset('site_assets/js/main.js') }}"></script>
	<script src="{{ asset('site_assets/assets/validate.js') }}"></script>
